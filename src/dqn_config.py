...
HYPER_PARAMS = {
    ...
    'eps_dec': 750000,                          # Epsilon decay in total environment steps
    ...
    'target_update_freq': 10000,                # Target network update frequency in total environment steps
    ...
    'max_episode_steps': 86400,                 # Time limit episode steps
